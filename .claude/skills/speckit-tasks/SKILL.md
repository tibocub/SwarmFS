...
**Tests are the DEFAULT, not optional**: per this project's constitution (`.specify/memory/constitution.md`
Principle II) and `AGENTS.md`'s existing testing workflow, generate a failing-first test task ahead of
every implementation task touching download/protocol/serving logic. Only skip test tasks for work with
no observable behavior change (pure docs/config/formatting).
